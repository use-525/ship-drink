...
if (isset($_POST['sbm'])) {
	...
	insert_trademark($trade_name, $trade_image);

	if ($okUpload) {
		move_uploaded_file($_FILES['trade_image']['tmp_name'], '../images/' . $trade_image);
	}
	$_SESSION['trademark'] = "Thêm nhãn hiệu thành công";
						...
						<div class="col-md-8">
							...
							<form role="form" method="POST" enctype="multipart/form-data">
								<div class="form-group">
									...
									<input required type="text" name="trade_name" class="form-control" placeholder="Tên danh mục...">
								</div>
								<div class="form-group">
									<label>Hình ảnh:</label>
									<input type="file" name="trade_image" class="form-file-input border" id="">
								</div>
