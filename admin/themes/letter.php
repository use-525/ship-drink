<?php
$list_letter = list_all_letter();
$id = $_GET['id'];
if (isset($_GET['id'])) {
	$id = $_GET['id'];
	delete_letter($id);
	$_SESSION['letter'] = "Xoá thành công";
	header("location: " . ROOT . "admin/?page=letter");
	die();
}
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Quản lý thư</li>
            </ol>
        </div>
        <!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Quản lý thư</h1>
            </div>
        </div>
        <!--/.row-->
        ...
        <?php if (isset($_SESSION['letter'])) : ?>
			<div class="alert alert-success"><?= $_SESSION['letter'] ?></div>
		<?php endif; ?>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table data-toolbar="#toolbar" data-toggle="table" class="table">
                            ...
                            <tbody>
                                <?php foreach ($list_letter as $l) : ?>
                                    <tr>
                                        <td style="text-align: center;"><?=$l['id']?></td>
                                        <td style="text-align: center;"><?=$l['letter_name']?></td>
                                        <td style="text-align: center;"><?=$l['letter_email']?></td>
                                        <td style="text-align: center;"><?=$l['letter_title']?></td>
                                        <td style="text-align: center;"><?=$l['letter_content']?></td>
                                        <td style="text-align: center;"><?=$l['letter_created_at']?></td>
                                        <td class="form-group" style="text-align: center;">
                                        <a href="<?= ROOT ?>admin/?page=letter&id=<?= $l['id'] ?>" onclick="return confirm('Bạn có chắc muốn xoá không?')" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
