...
if (isset($_POST['sbm'])) {
	...
	insert_promotion($pro_name, $pro_sale, $pro_image);

	if ($okUpload) {
		move_uploaded_file($_FILES['pro_image']['tmp_name'], '../images/' . $pro_image);
	}
	$_SESSION['promotion'] = "Thêm chương trình thành công";
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li><a href="">Quản lý chương trình khuyến mãi</a></li>
				<li class="active">Thêm chương trình khuyến mãi</li>
			</ol>
		</div>
		<!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Thêm chương trình khuyến mãi</h1>
			</div>
		</div>
		<!--/.row-->
		<div class="row">
						...
						<div class="col-md-8">
							...
							<form role="form" method="POST" enctype="multipart/form-data">
								<div class="form-group">
									...
									<input required type="text" name="pro_name" class="form-control" placeholder="Tên chương trình...">
								</div>
								<div class="form-group">
									<label>Giá trị:</label>
									<input required type="text" name="pro_sale" class="form-control" placeholder="Giá trị khuyến mãi...">
								</div>
								<div class="form-group">
									<label>Hình ảnh:</label>
									<input type="file" name="pro_image" class="form-file-input border" id="">
								</div>
